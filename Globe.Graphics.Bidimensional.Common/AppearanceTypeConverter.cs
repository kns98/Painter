...
// Type: Globe.Graphics.Bidimensional.Common.AppearanceTypeConverter
...
namespace Globe.Graphics.Bidimensional.Common
{
  ...
  {
    public override bool CanConvertTo(ITypeDescriptorContext context, Type destinationType) => destinationType == typeof (Appearance) || base.CanConvertTo(context, destinationType);
      ...
      Type destinationType)
    {
      ...
      return (object) Resource.ShapeAppearance;
    }
  }
}
